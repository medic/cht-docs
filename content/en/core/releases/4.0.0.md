...
To prepare for this release, please read through our [Preparing to Upgrade documentation]({{< ref "building/updates/preparing-for-4" >}}).
...
Credentials used for external integration via SIH or Outbound Push features are now stored in a different way which requires a manual upgrade step. Read about how to store credentials in 4.0.0 in the [API documentation]({{< ref "building/api#credentials" >}}).
