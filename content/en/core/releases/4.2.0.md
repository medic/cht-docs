...
{{< figure src="4.2.0-7872-training-deck.png" link="training-deck.png" class="col-12 col-lg-10" >}}
...
- [#6289](https://github.com/medic/cht-core/issues/6289): Investigate CouchDB3 compatibility
- [#6574](https://github.com/medic/cht-core/issues/6574): Remove use of "blacklist" and "master"
...
- [#7904](https://github.com/medic/cht-core/issues/7904): Update dependencies for 4.2.0
