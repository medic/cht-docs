...
NOTE: The bottom action bar can be temporarily re-enabled for specific users by granting them the `can_view_old_action_bar` permission; however, it will be completely removed in a future release. See the [Feature Flags]({{< relref "apps/guides/updates/feature-flags" >}}) documentation for more information.

{{< figure src="../images/4.2.0-7998-mobile.png" link="floating-action-button-mobile.png" class="left col-3 col-lg-3" >}}

{{< figure src="../images/4.2.0-7998-desktop.png" link="floating-action-button-desktop.png" class="left col-9 col-lg-9" >}}

{{< figure src="../images/4.2.0-7998-desktop-open.png" link="floating-action-button-desktop.png" class="left col-9 col-lg-9" >}}
<br clear="all">
...
A new feature was added to help health workers learn about changes to their CHT app remotely, directly in their app. Training Card content might include information about a newly deployed feature, changes to a [care guide]({{< relref "apps/concepts/care-guides" >}}), or simply a reminder about an underused feature or workflow. You can read more about it in the [Training Cards documentation]({{< relref "apps/features/training" >}}) and find some template content in the [resources]({{< relref "apps/guides/training/training-cards-resources" >}}) section on the documentation site to help you get started with Training Cards. 
