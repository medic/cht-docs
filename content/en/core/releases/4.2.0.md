...
You can read more about it in [the transitions configuration docs](https://docs.communityhealthtoolkit.org/apps/reference/app-settings/transitions/#create_user_for_contacts)!
