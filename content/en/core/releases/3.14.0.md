...
Additionally, a new [`to-bikram-sambat` xPath function]({{< ref "building/reference/forms/app#to-bikram-sambat" >}}) has been added that converts a `date` to a `string` containing the value of the date in the Bikram Sambat format.  
