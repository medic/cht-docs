...
|---------|-----------|--------------|-------------|
| 4.11.x  | Supported | 26-Sep-2024  | TBA         |
...
| cht-core | NodeJS | CouchDB | Supported browsers | SMS bridge | Android OS | cht-android |
|----|----|----|----|----|----|----|
| **4.4.x+** | N/A | 3.3.2+ | Chrome 90+, Android System WebView 90+, Firefox latest | cht-gateway | 5.0+ | 1.0+ |
| **4.0.x-4.3.x** | N/A | 2.x | Chrome 90+, Android System WebView 90+, Firefox latest | cht-gateway | 5.0+ | 1.0+ |
| **3.x** | 8.11+ | 2.x | Chrome 53+, Firefox latest | cht-gateway | 4.4+ | 0.4.5+ |
| **2.x** | 6+ | 1.6+ | Chrome 30+, Firefox latest | cht-gateway | 4.4+ | Any |
