...
3. With the introduction of configurable hierarchies, additional configuration must be added. More information about [how to set up configurable hierarchies]({{% ref "building/app-settings/configuring-application-settings#3-set-hierarchy" %}}).
...
[configuration information]({{% ref "building/app-settings/configuring-application-settings#3-set-hierarchy" %}}).
