...
3. With the introduction of configurable hierarchies, additional configuration must be added. More information about [how to set up configurable hierarchies]({{% ref "building/application-settings/app-settings#3-set-hierarchy" %}}).
...
[configuration information]({{% ref "building/application-settings/app-settings#3-set-hierarchy" %}}).
...
For more information about changes in purging, please refer to the [purging documentation]({{% ref "apps/guides/performance/purging#server-side" %}}).
