...
- Improved security by adding a new, more secure and more performant hashing algorithm. 
- An alternative Javascript view engine, which has improved performance when indexing views. The CHT is not yet ready for switching to this engine, as the two engines are not totally compatible, but will in a future release. 
