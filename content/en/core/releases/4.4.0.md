...
Hardcoded conditions that made `national_admin` role sometimes behave as CouchDb `_admin` was removed.
`national_admin` was added as role in default config for backwards compatibility.
