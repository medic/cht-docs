...
| Requests URL | Request Count | Avg Response time (min) | Sum Response time sum percent |
| -- | -- | -- | -- |
| /medic/_design/medic/_view/docs_by_replication_key | 103503	| 4.8 |	46.34% |
| **/medic-purged-role-.*/_changes**  | **105890**	 | **2.7** | 	**26.82%** |
| /medic/_design/medic/_view/contacts_by_depth |  140669	 | 0.2 | 	3.42% |
| /medic/_changes |  84461  | 0.4 |  3.26% |
