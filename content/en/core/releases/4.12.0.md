...
- `can_view_old_filter_and_search` (introduced in [3.17.0]({{< relref "core/releases/3.17.0#update-to-search-and-filters-on-the-contacts-and-reports-tabs" >}}))
- `can_view_old_action_bar` (introduced in [4.2.0]({{< relref "core/releases/4.2.0#floating-action-button" >}}))
