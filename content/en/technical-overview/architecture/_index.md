...
### [CHT Core Framework]({{< relref "technical-overview/architecture/cht-core" >}})
...
### [cht-conf]({{< relref "technical-overview/architecture/cht-conf" >}})

A command-line interface tool to manage and configure CHT application.

### [CHT Sync]({{< relref "technical-overview/architecture/cht-sync" >}})

A suite of tools for extracting and normalizing data from the Core Framework's CouchDB, and rendering the data in analytics dashboards to visualize key data for a CHT deployment. Read more detail on the [CHT Sync overview page]({{< relref "technical-overview/architecture/cht-sync" >}}) and the [cht-sync GitHub repository](https://github.com/medic/cht-sync).

### [CHT Watchdog]({{< relref "technical-overview/architecture/cht-watchdog" >}})

Monitoring and alerting for the CHT Core Framework to ensure CHWs are able to deliver care without interruption caused by server downtime.  Read more detail on the [CHT Watchdog overview page]({{< relref "technical-overview/architecture/cht-watchdog" >}}) and the [CHT Watchdog GitHub repository](https://github.com/medic/cht-watchdog).
