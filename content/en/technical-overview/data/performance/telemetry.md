...
| `enketo:<training-card>:add:render`                                | The time it took to render the training card. Added in 4.2.0                                                                                                                                                                             | `enketo:external-app:<action>` | The time taken from launching an external Android app to receiving the response. The `action` is the intent action of the launched app (e.g. `com.my-app.action.LOCATE`). Only recorded when running in the Android wrapper. Added in 5.2.0. | |                                                                                                                        | Yes. Added in 4.15.0 |
