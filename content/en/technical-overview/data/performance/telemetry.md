...
| `enketo:external-app:<action>`                                     | The time spent in a 3rd-party Android app, from launch until the user returns to the CHT. The `<action>` corresponds to the `action` field from the form's external app configuration.                                                                                                                                                                                 |
