...
To get summary data with one item per user, see the `/api/v2/export/user-devices` [API](/building/reference/openapi/#/Export/v2ExportUserDevicesGet), which was added in CHT 4.7.0. 
