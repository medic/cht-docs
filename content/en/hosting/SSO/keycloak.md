...
Use the [`/api/v1/credentials` REST api](/building/reference/openapi/#/Config/v1CredentialsKeyPut) to set the client secret as the `oidc:client-secret` credential.
