...
* Production 3.x CHT deployments should use [Docker Compose]({{< relref "hosting/3.x" >}})  - Note that 3.x is [end of life]({{< relref "cht-components/core/releases#supported-versions" >}})  and should only be used to support existing 3.x deployments.
