...
To make backups of just CouchDB data outside of the CHT docker infrastructure, please see [CouchDB's Backup docs](https://docs.couchdb.org/en/stable/maintenance/backups.html). Please note:
