...
To run custom models in separate containers, either use a package select with your dbt package name (`package:[YOUR_PACKAGE_NAME]`), or for more fine-grained control, add [tags](/hosting/analytics/tuning-dbt/#multiple-dbt-containers) to your models and use tag selectors (`tag:[YOUR_TAG]`).
