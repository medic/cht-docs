...
| `cht_api_*`                           | Any     |                                                   | Node.js metrics for CHT API as detailed by [prometheus-api-metrics](https://www.npmjs.com/package/prometheus-api-metrics) including default metrics and GC metrics. As of 4.3.0. |
