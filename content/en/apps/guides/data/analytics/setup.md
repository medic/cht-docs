...
There are three environment variable groups in the `.env.template` file. To successfully set up `cht-sync`, it is important to understand the difference between them.
...
|---------------------------|----------------------------------------------------|-----------------------------------------------------------------------------------------------------|
| `COMPOSE_PROJECT_NAME`    | `pipeline`                                         | (Optional)                                                                                          |
