...
1. `cd` to a directory where you want to run the exfiltration script
...
From here, you can use `scp` to get the data to your analytics server or to your workstation for further analysis. If you do this exfiltrating regularly, you can skip steps 3 and 4.  