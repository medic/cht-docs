...
- `chtScriptApi` (Optional) the CHT API that provides CHT-Core Framwework's functions to other parts of the app. More info on the API can be found [here]({{<ref "apps/reference/_partial_cht_api" >}}).
