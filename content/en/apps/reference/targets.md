...
| `aggregate` | `boolean` | As of 3.9, defines whether the target will be displayed on the TargetAggregates page. Relevant to [Supervisor view.]({{< ref "apps/features/targets/#supervisor-view" >}}) | no |
