...
If you don't already have a local dev env, follow the instructions on the [development setup instructions]({{< relref "community/contributing/code/core/dev-environment" >}}).
