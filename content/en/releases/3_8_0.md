...
* The specific meaning of task "resolution" has been augmented to accommodate the additional complexities of reporting a task's "state" in Postgres. Read [the documentation](/building/) for more information.
...
For more information, read the [configuration information](/building/reference/app-settings/transitions/#add_place-as-of-380).
