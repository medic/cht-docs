...
We have improved the [bulk upload](/building/training/users-bulk-load) feature to automatically assign a primary contact to a newly created place.
...
Android app submission now requires a URL to the apps' privacy policy. To facilitate this process we have made the [privacy policy](/building/privacy-policies) public in the login page.
