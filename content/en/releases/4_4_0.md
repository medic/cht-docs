...
{{< figure src="../images/4_4_0-8391-cht-dialogs.png" class="left col-12 col-lg-12" >}}
...
#### 4.3.0 vs 4.4.0 Average Synchronization Times (lower is better)

{{< figure src="../images/4_4_0-8238_sync_improvements.png" class="left col-12 col-lg-12" >}}
