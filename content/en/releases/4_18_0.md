...
- [`/api/v1/contact/{{uuid}}`](/building/reference/api/#/Contact/v1ContactIdGet)
- [`/api/v1/contact/uuid`](/building/reference/api/#/Contact/v1ContactUuidGet)
- [`/api/v1/report/{{uuid}}`](/building/reference/api/#/Report/v1ReportIdGet)
- [`/api/v1/report/uuid`](/building/reference/api/#/Report/v1ReportUuidGet)
