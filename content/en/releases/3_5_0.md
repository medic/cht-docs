...
Version 3.5.0 includes an integration with SIH, a facility based application in Mali. This enables patient referral information to be sent to a clinic and treatment data to be returned, closing the loop between the Community Health Worker and the clinic. This integration is possible thanks in part to a new [outbound push feature](/apps/reference/app-settings/outbound/), which is configurable and will facilitate integrations with other systems in the future. [medic#5499](https://github.com/medic/cht-core/issues/5499), and [medic#4813](https://github.com/medic/cht-core/issues/4813).
