...
Read the [feature overview](/building/targets/targets-overview/#supervisor-view) and the [technical documentation](/building/targets/targets-js/#targetsjs) to see how to configure this new aggregated target.
...
A [new API](/building/reference/api/#monitoring) has been added to allow tracking of a range of metrics in the CHT platform to make monitoring, alerting, and debugging of your instance easier.
