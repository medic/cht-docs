...
Read the [feature overview](/apps/features/targets/#supervisor-view) and the [technical documentation](/apps/reference/targets/#targetsjs) to see how to configure this new aggregated target.
...
Read more about configuring the `accept_case_reports` transition in the [CHT documentation](/apps/reference/app-settings/transitions/).

Issues: [cht-core#6291](https://github.com/medic/cht-core/issues/6291).

## Instance monitoring

A [new API](/apps/reference/api/#monitoring) has been added to allow tracking of a range of metrics in the CHT platform to make monitoring, alerting, and debugging of your instance easier.
