...
A [new API](/building/reference/api/#/Monitoring/v1MonitoringGet) has been added to allow tracking of a range of metrics in the CHT platform to make monitoring, alerting, and debugging of your instance easier.
