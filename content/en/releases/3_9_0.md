...
For more information read [the documentation](/building/integrations/dhis2/).
...
Read the [feature overview](/building/supervision/chw-aggregate-targets/) and the [technical documentation](/building/targets/targets-js/#targetsjs) to see how to configure this new aggregated target.
...
Read the [feature overview](/building/integrations/rapidpro/) to learn more about this new integration.
...
Read more about configuring the `accept_case_reports` transition in the [CHT documentation](/building/reference/app-settings/transitions/).

Issues: [cht-core#6291](https://github.com/medic/cht-core/issues/6291).

## Instance monitoring

A [new API](/building/reference/openapi/#/Monitoring/v1MonitoringGet) has been added to allow tracking of a range of metrics in the CHT platform to make monitoring, alerting, and debugging of your instance easier.
