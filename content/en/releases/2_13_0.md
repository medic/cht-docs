...
- multi_report_alerts transition added to sentinel. See the documentation in [cht-docs](/building/reference/app-settings/transitions/). Issue: [#3416](https://github.com/medic/cht-core/issues/3416)
