...
{{< cards >}}
{{< card  image="../images/5_0_reduction2.png"  title="34% less disk used" subtitle="Chart showing disk use going from 63.2GB on CHT 4.11 down to 41.7GB on CHT 5.0">}}
...
###  Optimizing synchronization to be faster, use less server CPU

As national deployments scaled up in excess of 5,000 users, Medic heard reports that the server CPU became overburdened. Upon close inspection,  one of the bottlenecks was found to be CHWs requesting the list of documents to replicate to to their device.  The API handling this request has been massively improved in CHT 5.0. This means synchronizations take less time and, in turn,  the server load is reduced which enables it to server more requests with only a software upgrade.


####  Synchronize times in seconds (lower is better)
...
-->
{{< cards cols="1">}}
{{< card  image="../images/5_0_faster_replication.png"   title="Up to 69% faster synchronization" subtitle="Chart showing users with 2.3k,  83k, 126.2k, 110.9k and 121.8k documents synchronizing against CHT 4.21 and CHT 5.0" >}}
{{< /cards >}}
<img src="../images/5_0_4color.png" style="width:20px; float:left;"> CHT 4.21
<img src="../images/5_0_5color.png" style="width:20px; float:left"> CHT 5.0
