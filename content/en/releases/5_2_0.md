...
Partnering with powerful open source projects has many benefits.  Aside from being able to leverage a massive body of like CouchDB which is finely tuned to deftly handling two way synchronizing of JSON documents, it's also always being improved.  CHT 5.2 includes CouchDB 3.5.2 which is now up to 60% faster at Nouveau indexing, which the CHT uses for online full text searches. The upgrade conveniently [fixes an issue](https://github.com/medic/cht-core/issues/11153) as well. See [the ticket](https://github.com/medic/cht-core/issues/11080) for more details.
