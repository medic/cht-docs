...
[//]: # (  mrjones says: apologies for the crass amount of HTML - we should likely templatize the ability )
...
- `/api/v1/replication-failure-logs` - [Docs](/building/reference/api/#/User/v1ReplicationFailureLogsGet) [#10794](https://github.com/medic/cht-core/issues/10794)
- `/api/v1/replication-health/failed` - [Docs](/building/reference/api/#/User/v1ReplicationHealthFailedGet) [#11146](https://github.com/medic/cht-core/issues/11146)
