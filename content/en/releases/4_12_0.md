...
To help better track and understand data usage in the CHT, additional metrics were added to the [monitoring api](/building/reference/openapi/#/Monitoring/v2MonitoringGet). The api now reports the following size values for each of the tracked databases and their view indexes:
