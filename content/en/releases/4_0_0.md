...
To prepare for this release, read through our [Preparing to Upgrade documentation](/hosting/cht/migration/preparing-for-4).

{{< callout type="warning" >}}
  Be aware that as this is a major upgrade some manual steps are required - following the usual upgrade process will not work. [Data migration documentation is coming soon](/hosting/cht), but in the meantime reach out on [the forum](https://forum.communityhealthtoolkit.org/) for direct support in upgrading. New projects should start on 4.0.0 to make the following upgrades easier.
{{< /callout >}}
...
Credentials used for external integration via SIH or Outbound Push features are now stored in a different way which requires a manual upgrade step. Read about how to store credentials in 4.0.0 in the [API documentation](/building/reference/openapi/#/Config/v1CredentialsKeyPut).
...
{{< figure src="../images/4_0_0-2967-startup-page.png" link="../images/4_0_0-2967-startup-page.png" >}}
