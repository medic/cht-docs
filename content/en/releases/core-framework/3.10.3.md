...
With configurable hierarchies, introduced in [3.7.0]({{% ref "releases/core-framework/3.7.0.md#configurable-hierarchies" %}}), the `contact_type` property became reserved to determine the type of contact.
