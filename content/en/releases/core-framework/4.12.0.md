...
- `can_view_old_filter_and_search` (introduced in [`3.17.0`]({{% ref "releases/core-framework/3.17.0.md" %}}))
- `can_view_old_action_bar` (introduced in [`4.2.0`]({{% ref "releases/core-framework/4.2.0.md" %}}))
