...
There are four new [functions](/building/forms/app/#cht-xpath-functions) that allow you to get the difference between two dates in various time formats. The functions are:
...
[Countdown widgets](/building/forms/app/#countdown-timer) can now be made required in forms. This means that the form will not be able to be submitted until the countdown widget has been completed.
