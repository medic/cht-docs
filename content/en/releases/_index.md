...
|-------------------|--------|---------|---------------------------------------------------------|-------------|------------|-------------|----------|
| **5.x.x+**        | 22     | 3.5.0+  | Chrome 107+, Android System WebView 107+, Firefox latest | cht-gateway | 5.0+       | 1.0+        | 1.1.0+   |
| **4.16.x-4.22.x** | 22     | 3.4.2+  | Chrome 90+, Android System WebView 90+, Firefox latest  | cht-gateway | 5.0+       | 1.0+        | 1.1.0+   |
