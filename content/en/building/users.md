...
> [!NOTE]
> Advanced configuration options are available for a specific offline user role to manage what [level of data](/technical-overview/data/performance/replication) is synced to their device. 
