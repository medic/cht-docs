...
You can read more about it in [the transitions configuration docs]({{< relref "building/application-settings/app-settings/transitions#create_user_for_contacts" >}})!
