...
The CHT now supports scheduling when outbound push tasks are run based on a cron expression. Read about how to set this up in the [outbound push documentation]({{< relref "building/application-settings/app-settings/outbound#cron" >}}).
