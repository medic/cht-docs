...
{{< cards rows="4" >}}
{{< card link="../../branding/android/android-12-prompt.png" image="../../branding/android/android-12-prompt.png"  method="resize">}}
{{< card link="android-prompt.png" image="android-prompt.png"  method="resize">}}
{{< /cards >}}
