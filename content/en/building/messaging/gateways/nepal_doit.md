...
Use the [CHT credentials API](/building/reference/api/#/Config/v1CredentialsKeyPut) to securely store the credentials by running the commands below. Be sure to replace a valid `user`, `pass` and `hostname` in the command:
