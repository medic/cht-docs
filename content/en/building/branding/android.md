...
Also be sure to have a working **[Development Environment]({{< ref "community/code/android/development-setup" >}})**.
...
4. [Release the flavor]({{< ref "community/code/android/releasing" >}}).
