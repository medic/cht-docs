...
Once the flavor is [bui````lt](/building/branding/android) there are many different ways to publish the binaries for installation.
...
2. Download the correct APK on to the phone. It's important to select the right APK for the instruction set and Android version, as documented [in this table](/community/contributing/code/android/development-setup#apks).  This is likely easiest done by using the phone's browser to navigate to the download page.
