...
| `collapsed `          | `boolean`                       | Added in CHT `5.2.0`. The card details are collapsed by default when the card is shown. The user can expand the details by tapping on the card's header. Default is `false`.                                                                                                                                                                                                                                                                                                          | no       |
