...
* `useview_task` - This is a materialized view of the data from the [task document schema]({{< ref "technical-overview/concepts/db-schema#tasks" >}}).
* `task_state` - The meaning of each task state is explained in the [task document schema]({{< ref "technical-overview/concepts/db-schema#tasks" >}}).
