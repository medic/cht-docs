...
| tasks.max_task_notifications                   | The maximum number of task notifications to show at once.                                                                                                                                                                                                                                                                                                                                                                                                                         | 8       | 5.1.0   |
...
| `uniquePhone(field)` | Returns `true` if a contact with the phone number already exists. _Added in 4.3.0_ |
