...
Using [telemetry](/technical-overview/data/performance/telemetry) you can monitor user interaction with each training card "set". Some key metrics you can view include:
