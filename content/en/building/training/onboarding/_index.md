...
It is preferable to remove the training app from devices, and [monitor the training instance for unexpected activity](/building/training/training-instance) that can be brought over to the production instance if needed.
