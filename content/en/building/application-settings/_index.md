...
* While it is possible to [update the hierarchy configuration]({{< relref "building/updates/moving-contacts" >}}) after launch it can be difficult and potentially disruptive to users. Try and avoid this by planning ahead as best as possible.
