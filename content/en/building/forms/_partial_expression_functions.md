...
| `extensionLib(name, ...args)`                                                | _(Added `5.2.0`)_ Returns the result of calling the specified [exstension-lib function](/building/reference/extension-libs) with the provided arguments.                                                                                                  |
