...
With more than 165,000 health workers using these tools to support more than 4 million caring activities every month, the CHT is the most full-featured, mature, and widely-used open source software toolkit designed specifically for community health systems. Hundreds of individuals contribute to the CHT as designers, developers, researchers, health policy experts, health system implementers, and frontline health workers. For more about the unique strengths of the CHT open source community and the technology we’re building together, see [Why the CHT]({{< ref "/why-the-cht" >}}) ?
...
### Have Questions?
Want to learn alongside a community of users? Join the CHT community forum and let us know how we can help! And if you like what you see, don’t forget to star [the CHT Core GitHub repo](https://github.com/medic/cht-core) :)
